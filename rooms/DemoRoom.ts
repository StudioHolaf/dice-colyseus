        ...
        if (data.type === "askServerForTirage") {
            ...
            if (this.isClientChallenger(client.id)) {
                ...
                if (dicesStates.length > 0) {
                    ...
                    console.log("possibilities : "+ data.dicesPossibilitiesJsoned[0][0].length);
                    var rnd1 = Math.floor(Math.random() * data.dicesPossibilitiesJsoned[0][0].length); // le dé était sur 1 et n'a jamais changer en 15 rerolls
